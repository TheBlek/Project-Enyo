...
namespace UnityEditor
{
    ...
    public class RuleTileEditor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            tile._tile_priority = EditorGUILayout.IntField("Tile Priority", tile._tile_priority);
            tile._both_side_reaction = EditorGUILayout.Toggle("Both side reaction", tile._both_side_reaction);
