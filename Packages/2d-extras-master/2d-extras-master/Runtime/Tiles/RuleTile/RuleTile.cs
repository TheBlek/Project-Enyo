...
namespace UnityEngine
{
    ...
    {
        public int _tile_priority = 0;
        public bool _both_side_reaction = false;
        ...
        public virtual bool RuleMatch(int neighbor, TileBase other)
        {
            ...
            {
                var tile = other as RuleTile;
                switch (neighbor)
                {
                    case TilingRule.Neighbor.This: return tile == this || (tile._tile_priority >= this._tile_priority && !_both_side_reaction && !tile._both_side_reaction);
                    case TilingRule.Neighbor.NotThis: return tile != this && (tile._tile_priority < this._tile_priority || _both_side_reaction || tile._both_side_reaction);
                }
            }
